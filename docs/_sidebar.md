...
- **Architecture**
  ...
  - [Core Impact Map](architecture/04_CORE_WALLET_RPC_INDEXER_EXPLORER_IMPACT.md)
  - [Windows Desktop Direction](architecture/05_WINDOWS_DESKTOP_DIRECTION.md)
...
- **Protocol**
  ...
  - [Protocol Overview Details](protocol/00_PROTOCOL_OVERVIEW.md)
  - [Chain Parameters](protocol/01_CHAIN_PARAMETERS.md)
  - [VIRE Units and Supply](protocol/02_VIRE_UNITS_AND_SUPPLY.md)
...
- **API**
  ...
  - [RPC Models](api/02_RPC_RESPONSE_MODELS.md)
...
- **Tokenomics**
  ...
  - [VIRE Tokenomics](tokenomics/00_TOKENOMICS_OVERVIEW.md)
...
- **Release**
  ...
  - [Mainnet Candidate Checklist](release/MAINNET_CANDIDATE_CHECKLIST.md)
...
- **Project Direction**
  ...
  - [Licensing Policy](legal/LICENSING_POLICY.md)
